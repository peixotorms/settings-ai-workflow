...
export ANTHROPIC_AUTH_TOKEN="{{QWEN_AUTH_TOKEN}}"
export ANTHROPIC_DEFAULT_OPUS_MODEL="qwen/qwen3-coder-480b-a35b-instruct"
export ANTHROPIC_DEFAULT_SONNET_MODEL="qwen/qwen3-coder-480b-a35b-instruct"
export ANTHROPIC_MODEL="qwen/qwen3-coder-480b-a35b-instruct"
export ANTHROPIC_DEFAULT_HAIKU_MODEL="deepseek/deepseek-v3.2-exp"
...
if ! claude mcp list 2>/dev/null | grep -q '^codex'; then
  claude mcp add codex -s user -- codex -m gpt-5 -c model_reasoning_effort="high" mcp 2>/dev/null
fi
